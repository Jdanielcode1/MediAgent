      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/landing" className="text-xl font-bold text-primary">
              MediAgent
            </Link>
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              AI-powered sales agents for medical device companies.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 dark:border-gray-700 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} MediAgent, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
